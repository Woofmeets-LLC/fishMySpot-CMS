...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    featuredSpots: Attribute.Component<'featured.blog-featured-spot', true>;
...
export interface ApiDiscountCardDiscountCard extends Schema.CollectionType {
  collectionName: 'discount_cards';
  info: {
    singularName: 'discount-card';
    pluralName: 'discount-cards';
    displayName: 'Discount Card';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    valid: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFeaturedSpotFeaturedSpot extends Schema.CollectionType {
...
export interface ApiOnboardingSourceOnboardingSource
  extends Schema.CollectionType {
  collectionName: 'onboarding_sources';
  info: {
    singularName: 'onboarding-source';
    pluralName: 'onboarding-sources';
    displayName: 'Onboarding Source';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::onboarding-source.onboarding-source',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiStateState extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required;
    statePageHeader: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    statePageDescription: Attribute.Text &
      Attribute.SetMinMaxLength<{
        maxLength: 160;
      }>;
    featuredImage: Attribute.Media & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::discount-card.discount-card': ApiDiscountCardDiscountCard;
      'api::featured-spot.featured-spot': ApiFeaturedSpotFeaturedSpot;
      'api::feedback.feedback': ApiFeedbackFeedback;
      'api::gift-card.gift-card': ApiGiftCardGiftCard;
      'api::onboarding-source.onboarding-source': ApiOnboardingSourceOnboardingSource;
